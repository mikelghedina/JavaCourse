...
public class InitialStudents {
     ...
     public static ArrayList<Student> studentsList(){
         ...
         students.add(new Student("Andrea", "Toronto", 60, 1.68,
                 new Date(30,12,1997),"35689574K",new Apartment("Girona Apartment"),InitialPets.fillPets(),"andtoro","andtoro356"));

         students.add(new Student("Laia", "Ausio", 58, 1.60,
                 new Date(12,2,1991),"75689525E", new Apartment("Tarragona Apartment"),InitialPets.fillPets(), "laiaus", "laiaus756"));
         return students;
     }
}
